...
const VerProveedorPage = () => {
  ...
  const handleToggle = () => {
    toggleEstado(id);
    setProveedor(prev => ({ ...prev, estado: !prev.estado }));
  };
          ...
          <div className="ver-header-left">
            ...
            <div>
              ...
              <div className="ver-meta">
                ...
                <span className={`badge-estado ${proveedor.estado ? 'estado-activo' : 'estado-inactivo'}`}>
            ...
            <div className="ver-fields">
              ...
              <div className="ver-field">
                ...
                <span className="vf-value ver-estado-wrap">
                  <button
                    className={`toggle-btn-ver ${proveedor.estado ? 'toggle-on' : 'toggle-off'}`}
                    onClick={handleToggle}
                  >
                    <span className="toggle-thumb"></span>
                  </button>
                  <span className={proveedor.estado ? 'text-activo' : 'text-inactivo'}>
                    {proveedor.estado ? 'Activo' : 'Inactivo'}
                  </span>
                </span>
              </div>
          ...
          <div className="ver-card ver-card-full">
            ...
            <div className="ver-fields">
              ...
              <div className="ver-field">
                ...
                <span className="vf-value" style={{ fontFamily: 'monospace', color: '#888' }}>{proveedor.id}</span>
              </div>
            </div>
          </div>
        </div>
