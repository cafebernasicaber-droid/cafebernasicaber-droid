  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{
        background:'#1a1a1a', borderRadius:18, width:'100%', maxWidth:660,
        ...
        <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',padding:'20px 24px 16px',borderBottom:'1px solid rgba(255,255,255,.07)' }}>
          <div style={{ display:'flex',alignItems:'center',gap:12 }}>
            ...
            <div>
              <div style={{ fontWeight:800,fontSize:16,color:'#f0ece4' }}>{proveedor.nombre}</div>
              <div style={{ display:'flex',gap:6,marginTop:4,flexWrap:'wrap' }}>
                <span className="badge-cat">{proveedor.categoria}</span>
                <span style={{ padding:'2px 8px',borderRadius:20,fontSize:11,fontWeight:600,
                  background:proveedor.estado?'rgba(46,125,50,.2)':'rgba(255,255,255,.06)',
                  color:proveedor.estado?'#81C784':'#a09880',
                  border:`1px solid ${proveedor.estado?'rgba(129,199,132,.3)':'rgba(255,255,255,.1)'}` }}>
        ...
        <div style={{ padding:'20px 24px' }}>
          <div style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:14,marginBottom:14 }}>
            ...
            <div style={{ background:'#2a2a2a',borderRadius:12,padding:'16px 18px',border:'1px solid rgba(255,255,255,.07)' }}>
              <div style={{ fontSize:11,fontWeight:700,color:'#a09880',textTransform:'uppercase',letterSpacing:'0.6px',marginBottom:12 }}>Información de Contacto</div>
              {[
                ...
                ['Estado',
                  <div style={{ display:'flex',alignItems:'center',gap:8 }}>
                    ...
                    <span style={{ fontSize:13,fontWeight:600,color:proveedor.estado?'#81C784':'#a09880' }}>
                      {proveedor.estado?'Activo':'Inactivo'}
                    </span>
                  </div>
                ],
            ...
            {/* Ubicación */}
            <div style={{ background:'#2a2a2a',borderRadius:12,padding:'16px 18px',border:'1px solid rgba(255,255,255,.07)' }}>
              <div style={{ fontSize:11,fontWeight:700,color:'#a09880',textTransform:'uppercase',letterSpacing:'0.6px',marginBottom:12 }}>Ubicación y Categoría</div>
              {[
          ...
          <div style={{ background:'#2a2a2a',borderRadius:12,padding:'14px 18px',border:'1px solid rgba(255,255,255,.07)',marginBottom:14 }}>
            <div style={{ fontSize:11,fontWeight:700,color:'#a09880',textTransform:'uppercase',letterSpacing:'0.6px',marginBottom:6 }}>Observaciones</div>
            <p style={{ fontSize:13,color:'#c5bfb5',lineHeight:1.6,margin:0 }}>{proveedor.observaciones || 'Sin observaciones registradas.'}</p>
            <div style={{ marginTop:10,fontSize:12,color:'#666' }}>Registrado: {formatDate(proveedor.fechaCreacion)}</div>
          </div>
      ...
      <div className="insumos-root">
        ...
        {(modal === 'nuevo' || esEdicion) && (
          <div className="modal-overlay" onClick={closeModal}>
            <div onClick={e => e.stopPropagation()} style={{
              background:'#1a1a1a',borderRadius:16,width:'90%',maxWidth:680,
              ...
              <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:20 }}>
                <div style={{ display:'flex',alignItems:'center',gap:12 }}>
                  ...
                  <div>
                    <h3 style={{ margin:0,fontSize:18,fontWeight:800,color:'#f0ece4' }}>{esEdicion?'Editar Proveedor':'Nuevo Proveedor'}</h3>
                    <p style={{ margin:0,fontSize:12,color:'#a09880' }}>{esEdicion?`Modificando: ${modal.nombre}`:'Completa los campos para registrar un proveedor'}</p>
                  </div>
                </div>
                <button onClick={closeModal} style={{ background:'none',border:'none',cursor:'pointer',color:'#a09880',fontSize:22,lineHeight:1,padding:4 }}>×</button>
              </div>
              {serverError && (
