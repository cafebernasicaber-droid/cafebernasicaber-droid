                  ...
                  {editId === c.id ? (
                    ...
                    <>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                        ...
                        <button onClick={() => setDeleteTarget(c)} title="Eliminar categoría"
...
const InsumosPage = () => {
  ...
  const stockBajoList = insumos.filter(i => i.estado === 'Activo' && Number(i.stockActual) <= Number(i.stockMinimo));
      ...
      <div className="insumos-root">
        ...
        {stockBajoList.length > 0 && (
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8, fontSize: 12.5, fontWeight: 700, color: '#E65100' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
              {stockBajoList.length} insumo{stockBajoList.length !== 1 ? 's' : ''} con stock bajo
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {stockBajoList.map(i => (
                <div key={i.id} style={{
                  display: 'flex', flexDirection: 'column', gap: 1, padding: '6px 12px', borderRadius: 10,
                  background: 'rgba(230,115,0,0.10)', border: '1px solid rgba(230,115,0,0.28)', fontSize: 12, color: '#E65100',
                }}>
        ...
        <div className="insumos-toolbar">
          ...
          <div style={{ display: 'flex', gap: 12, marginLeft: 'auto' }}>
            <button className="btn-add" style={{ margin: 0, background: 'var(--bg-surface-3)', color: 'var(--text-primary)', border: '1px solid rgba(255,255,255,.12)' }} onClick={() => setModal('categorias')}>
