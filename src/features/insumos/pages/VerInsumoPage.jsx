...
const VerInsumoPage = () => {
  ...
  const handleDelete = async () => { await remove(Number(id)); navigate('/insumos'); };

  const handleToggle = async () => {
    await toggleEstado(Number(id));
    setInsumo(prev => ({ ...prev, estado: prev.estado === 'Activo' ? 'Inactivo' : 'Activo' }));
  };
    ...
    <Layout>
      <div className="ver-root">
          ...
          <div className="ver-header-left">
            ...
            <div>
              ...
              <div className="ver-meta">
                ...
                <span className={`badge-estado ${insumo.estado === 'Activo' ? 'estado-activo' : 'estado-inactivo'}`}>
        ...
        <div className="ver-grid">
            ...
            <div className="ver-fields">
              ...
              <div className="ver-field">
                ...
                <span className="vf-value ver-estado-wrap">
                  <button className={`toggle-btn-ver ${insumo.estado === 'Activo' ? 'toggle-on' : 'toggle-off'}`} onClick={handleToggle}>
                    <span className="toggle-thumb"></span>
                  </button>
                  <span className={insumo.estado === 'Activo' ? 'text-activo' : 'text-inactivo'}>
                    {insumo.estado === 'Activo' ? 'Activo' : 'Inactivo'}
                  </span>
                </span>
              </div>
          ...
          <div className="ver-card">
            <h3 className="ver-card-title">Stock & Precio</h3>
            <div className="ver-fields">
              <div className="ver-field">
          ...
          <div className="ver-card ver-card-full">
            ...
            <div className="ver-fields">
              ...
              <div className="ver-field"><span className="vf-label">ID del insumo</span><span className="vf-value" style={{ fontFamily: 'monospace', color: 'var(--text-muted)' }}>{insumo.id}</span></div>
            </div>
          </div>
        </div>
