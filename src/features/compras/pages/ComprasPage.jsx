            ...
            <div>
              ...
              <div style={{ display:'flex',gap:6,marginTop:4,flexWrap:'wrap' }}>
                ...
                {esAnulada
                  ...
                  : <span style={{ padding:'2px 8px',borderRadius:20,fontSize:11,fontWeight:600,background:'#E8F5E9',color:'#2E7D32',border:'1px solid #A5D6A7' }}>Activa</span>
                }
              </div>
            </div>
          </div>
      ...
      <div className="insumos-root">
        ...
        <div className="insumos-toolbar">
          ...
          <div style={{ display:'flex',gap:8 }}>
            <button
              style={{ padding:'10px 18px',borderRadius:10,border:'1px solid #ddd',background:'white',color:'#555',fontSize:13,fontWeight:600,cursor:'pointer',display:'flex',alignItems:'center',gap:6 }}
