  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div onClick={e => e.stopPropagation()} style={{
        background:'#1e1e1e', borderRadius:18, width:'100%', maxWidth:680,
        ...
        <div style={{ display:'flex',gap:12,alignItems:'center',marginBottom:16,flexWrap:'wrap' }}>
          <div style={{ display:'flex',alignItems:'center',gap:8 }}>
            ...
            <input type="date" value={desde}
              ...
              style={{ padding:'6px 10px',borderRadius:8,border:'1px solid rgba(255,255,255,.12)',fontSize:13 }} />
          </div>
          <div style={{ display:'flex',alignItems:'center',gap:8 }}>
          ...
          {(desde || hasta) && (
            <button onClick={() => { setDesde(''); setHasta(''); }}
              style={{ padding:'6px 14px',borderRadius:8,border:'1px solid rgba(255,255,255,.12)',background:'#1e1e1e',color:'#a09880',fontSize:13,cursor:'pointer' }}>
              Limpiar filtros
            </button>
          )}
        </div>
