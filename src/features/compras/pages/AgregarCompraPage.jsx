...
const AgregarCompraPage = () => {
  ...
  const handleSubmit = async (data) => {
    setServerError('');
    try {
      // El backend espera proveedor_id (snake_case); el formulario trabaja
      // con proveedorId. Antes se enviaba tal cual y la compra siempre
      // quedaba guardada sin proveedor asociado.
      const payload = { ...data, proveedor_id: data.proveedorId };
