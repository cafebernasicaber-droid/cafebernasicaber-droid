...
function AdicionModal({ inicial, onClose, onSave }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const r = inicial ? await adicionesService.update(inicial.id, form) : await adicionesService.create(form);
                      ...
                      <tr key={a.id}>
                        ...
                        <td>
                          <div className="actions-group">
                            ...
                            <button className="btn-anular" onClick={() => setDelAdic(a)}>✕ Stop</button>
                          </div>
                        </td>
                      </tr>
                    ))}
